...
To download RTM task data as an iCalendar file, use this URL:
https://www.rememberthemilk.com/icalendar/YOUR_RTM_USER_NAME/

The script looks for an input file named 'iCalendar_Service.ics' in the
...
def main():
    ...
    try:
        todos = ICSParser(codecs.open('iCalendar_Service.ics',
